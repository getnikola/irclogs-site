...
BLOG_AUTHOR = "Chris Warrick"  # (translatable)
...
POSTS = (
    ...
    ("logs/*.log", "logs", "log.tmpl"),
    ("posts/*.txt", "posts", "post.tmpl"),
)
PAGES = (
    ("stories/*.rst", "", "story.tmpl"),
    ("stories/search.html", "", "search.tmpl"),
...
# (translatable)
CONTENT_FOOTER = 'Maintained by <a href="mailto:{email}">{author}</a>, powered by <a href="https://getnikola.com/" rel="nofollow">Nikola</a> and <a href="https://chriswarrick.com/kwbot/">KwBot</a>.  Rebuilt every hour.'
...
FILE_METADATA_REGEXP = 'logs/(?P<date>\d{4}-\d{2}-\d{2})\.log'
